...
Detailed usage for every `gh team-kit` command. See the [README](../README.md) for an overview and quick start.
...
- **Member Privileges Management**: Get, set, and copy organization member privilege settings.
...
- **Copilot Management**: Show GitHub Copilot usage metrics for a team, and install/manage Copilot CLI canvas extensions bundled with this tool.
