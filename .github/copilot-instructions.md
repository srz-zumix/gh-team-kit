...
* ツールの概要・特徴・インストール・クイックスタート・各ドキュメントへのリンクのみを簡潔に記載します
* 各コマンドの詳細な Usage は docs/commands.md に記載し、README には書きません
...
* docs/commands.md は英語で記載します
* docs/commands.md を更新したら SKILL も更新してください
...
* サブコマンドのグルーピング順は、docs/commands.md 全体で一貫性を持たせてください
* コマンド説明は、実装と乖離しないよう定期的に見直してください
* コマンドの追加・削除・引数変更時は必ず docs/commands.md も更新してください
